...
class TheatersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theater" do
    assert_difference("Theater.count") do
      post theaters_url, params: { theater: { capacity: @theater.capacity, location: @theater.location, name: @theater.name } }
    end
  ...
  test "should update theater" do
    patch theater_url(@theater), params: { theater: { capacity: @theater.capacity, location: @theater.location, name: @theater.name } }
